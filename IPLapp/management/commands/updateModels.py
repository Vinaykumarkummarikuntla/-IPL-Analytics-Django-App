...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        # database connections herewin
        with open('/home/vinay/django/ipl-django/data/matches.csv', 'r',encoding="utf8") as file:
            ...
            for match in match_obj:
                ...
                model.save()
        with open('/home/vinay/django/ipl-django/data/deliveries.csv', 'r', encoding="utf8") as file:
